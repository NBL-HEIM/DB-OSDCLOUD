    ...
    Else
        {
            ...
            Write-Host "Updating device with new tag.  Please wait 5 minutes... "
...
Write-Host "Please verify device enrollment in the Intune Autopilot Device list before continuing"
Write-Host "Serial = $Serial"
Write-Host "Autopilot Assiged Tag = $Tag"
Write-Host "Computer Name = $Tag$Serial"
Start-Sleep -Seconds 10
